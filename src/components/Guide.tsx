...
import { ChevronDown, ChevronUp, Italic } from "lucide-react";
      ...
      <Card className="mb-4 border border-gray-200 bg-gray-50 shadow-sm">
        <CardContent className="p-6 text-gray-700">
          ...
          <p>
            ...
            <i>Pop Goes the Bubble Algorithm Explained</i> section!
          </p>
        </CardContent>
      </Card>
