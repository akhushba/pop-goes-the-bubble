...
export const tagCategories = [
  ...
  { tag: "Glaze", category: "Art & Creativity" },
  { tag: "Nightshade", category: "Art & Creativity" },

  // Conservative
  { tag: "Anti-Liberal", category: "Conservative" },
  { tag: "Anti-Woke", category: "Conservative" },
  { tag: "Conservative", category: "Conservative" },
  { tag: "MAGA", category: "Conservative" },
  { tag: "Project 2025", category: "Conservative" },
  { tag: "Trump", category: "Conservative" },
  { tag: "Fox News", category: "Conservative" },
  { tag: "Pro-Life", category: "Conservative" },
  { tag: "Elon Musk", category: "Conservative" },
  { tag: "Pierre Poilievre", category: "Conservative" },
  // Liberal
  { tag: "Liberal", category: "Liberal" },
  { tag: "Anti-Trump", category: "Liberal" },
  { tag: "Equality", category: "Liberal" },
  { tag: "LGBTQ+ Rights", category: "Liberal" },
  { tag: "MeToo", category: "Liberal" },
  { tag: "Pro-Choice", category: "Liberal" },
  { tag: "Social Justice", category: "Liberal" },
  { tag: "Mark Carney", category: "Liberal" },
